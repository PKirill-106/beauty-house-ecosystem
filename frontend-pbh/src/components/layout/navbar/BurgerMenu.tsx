...
export default function BurgerMenu() {
	...
	return (
		<div className='flex justify-end'>
			...
			<div
				ref={menuRef}
				className={`fixed z-100 top-0 right-0 w-3/4 max-w-xs h-screen bg-white shadow-lg transform transition-transform overflow-y-auto duration-300 md:hidden ${
